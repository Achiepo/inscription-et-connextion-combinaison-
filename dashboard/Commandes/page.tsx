  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="mb-6 flex justify-between items-center">
        <input
          type="text"
          className="border border-gray-300 rounded-lg p-3 w-1/3 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-800"
          ...
          <table className="min-w-full table-auto">
            <thead className="bg-gray-200">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-gray-700">Produit</th>
                <th className="px-4 py-3 text-left text-gray-700">Montant</th>
            ...
            <tbody>
              {currentCommandes.map((cmd) => (
                <tr key={cmd.id} className="border-b hover:bg-gray-100 transition duration-200 ease-in-out">
                  <td className="px-4 py-3 text-gray-800">{cmd.id}</td>
                  <td className="px-4 py-3 text-gray-800">{cmd.client}</td>
                  <td className="px-4 py-3 text-gray-800">{cmd.produit}</td>
                  <td className="px-4 py-3 text-gray-800">{cmd.montant} FCFA</td>
                  ...
                  <td className="px-4 py-3 text-gray-800">{cmd.date}</td>
                </tr>
              ))}
            </tbody>
          </table>
