...
const clientsData: Client[] = [
  { id: 1, name: "Pierre Durand", email: "pierre.durand@example.com", phone: "+221 77 123 4567", status: "actif" },
  { id: 2, name: "Marie Ndiaye", email: "marie.ndiaye@example.com", phone: "+221 77 234 5678", status: "inactif" },
  { id: 3, name: "Mamadou Sarr", email: "mamadou.sarr@example.com", phone: "+221 77 345 6789", status: "actif" },
  { id: 4, name: "Aissatou Diallo", email: "aissatou.diallo@example.com", phone: "+221 77 456 7890", status: "inactif" },
  { id: 5, name: "Omar Ba", email: "omar.ba@example.com", phone: "+221 77 567 8901", status: "actif" },
];
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-4xl font-semibold text-gray-900">Gestion des Clients</h1>
        <div className="flex items-center space-x-3">
          <FaFilter className="text-gray-500" />
          <select
            value={filterStatus}
            onChange={(e) => handleStatusFilter(e.target.value)}
            className="border border-gray-300 rounded-lg p-2 text-sm focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 ease-in-out"
          >
